...
export function FAQSection() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "The Salute Marathon will take place on August 9, 2025, at Island Grounds, Chennai. The event starts at 5:00 AM with the 5K race, followed by the 10K race at 5:30 AM. The entire event concludes by 7:30 AM.",
    },
    {
      question: "What are the registration fees?",
      answer:
        "Registration fees are ₹333 for the 5K race and ₹555 for the 10K race. Both packages include a race kit with a dry-fit t-shirt, finisher medal, digital certificate, refreshments, and breakfast.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Please bring a valid government-issued photo ID, your registration confirmation, and wear comfortable running attire. We recommend bringing a small personal water bottle, though hydration stations will be available along the route. Avoid bringing valuables as storage facilities are limited.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Registration fees are non-refundable once confirmed. However, in case of event cancellation due to unforeseen circumstances, full refunds will be processed within 10-15 working days. Transfer to another person is allowed up to 3 days before the event.",
    },
    {
      question: "How can I track my race results?",
      answer:
        "All participants will receive digital certificates with their completion time. Race results will be published on our official website and social media channels within 48 hours of the event. You can also track your performance through our mobile app (details provided in your race kit).",
    },
  ]
