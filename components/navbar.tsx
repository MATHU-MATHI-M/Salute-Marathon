...
export function Navbar({ onOpenModal }: { onOpenModal: () => void }) {
  ...
  return (
    ...
    >
      <div className="nav-container flex justify-between items-center px-4 py-4 max-w-[1400px] mx-auto md:px-8">
        <Link
          href="#home"
          className="nav-logo flex items-center gap-3 font-poppins font-extrabold text-text-dark text-xl"
        >
          <div className="logo-icon w-[50px] h-[50px] bg-primary-gradient rounded-full flex items-center justify-center text-white text-2xl transition-all duration-400 ease-DEFAULT shadow-light animate-pulse hover:scale-110 hover:rotate-10 hover:shadow-glow hover:animate-none">
            <Running />
          </div>
